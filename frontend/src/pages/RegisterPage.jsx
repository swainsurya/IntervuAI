      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-12">
        <div className="w-full max-w-md space-y-6 md:space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-2">Join PrepWise and ace your interviews</p>
          </div>
          ...
          <div className="bg-[#1E1E1E] p-8 rounded-xl border border-gray-800 shadow-lg">
            <form className="space-y-6">
              <div className="space-y-2">
                ...
                <Input id="firstName" type="text" className="bg-[#2A2A2A] border-gray-700 text-white" placeholder="John Doe" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="confirmPassword" type="password" className="bg-[#2A2A2A] border-gray-700 text-white" placeholder="********" />
              </div>
